...
from grade import read_ground_truths, apply_kernel_all_channels, get_x_y_from_flatten_arr, \
...
if __name__ == '__main__':
    ...
    gd_truth_file = sys.argv[2]
    output_file = sys.argv[3]
    inject_gd_truth_in_image(input_img, gd_truth_file, output_file)
